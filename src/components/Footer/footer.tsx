          ...
          <section className="bg-[#f9f9f9] py-10">
              <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                  ...
                  <div className="flex gap-6">
                      <Image src="/svg/facebook.svg" alt="logo 1" height={6} width={6} className="w-6 h-6 rounded-full" />
                      <Image src="/svg/twitter.svg" alt="logo 1" height={6} width={6} className="w-6 h-6 rounded-full" />
                      <Image src="/svg/instagram.svg" alt="logo 1" height={6} width={6} className="w-6 h-6 rounded-full" />
